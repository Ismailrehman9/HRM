...
Route::get('/maintenance', function () {
    ...
    return '<h1>All maintenance tasks completed</h1>';
});
...
Route::get('editt/{id}', [TicketController::class, 'editt'])->name('editt');
...
Route::post('get.status', [TicketController::class, 'get_status'])->name('get.status');

Route::post('/statusUpdate', [TicketController::class, 'update_status'])->name('update.status');