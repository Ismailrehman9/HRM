                            ...
                            <tbody class="list">
                                @foreach ($announcements as $announcement)
                                    <tr>
                                        ...
                                        @foreach($users as $row)
                                        @if ($row->id == $announcement->created_by)
                                            <td>{{ $row->name }}</td>
                                        @endif
                                    @endforeach
                                    </tr>
...
@push('script-page')
    ...
    @if (Auth::user()->type == 'company' || Auth::user()->type == 'hr' || Auth::user()->type == 'General Manager' || Auth::user()->type == 'Manager')
