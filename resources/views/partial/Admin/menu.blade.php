                ...
                @if (Gate::check('Manage Set Salary') || Gate::check('Manage Pay Slip'))
                    <li
                        ...
                        <ul class="dash-submenu ">
                            ...
                            @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'SuperAdmin' || \Auth::user()->type == 'hr' || \Auth::user()->type == 'General Manager' )
                ...
                @if (Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage TimeSheet'))
                    <li class="dash-item dash-hasmenu">
                        ...
                        <ul class="dash-submenu">
                            ...
                            @endcan
                             @if (\Auth::user()->type === 'company' || \Auth::user()->type === 'SuperAdmin' || \Auth::user()->type === 'hr' )
...
@endif
                ...
                @if(\Auth::user()->type == 'SuperAdmin' || \Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->type === 'hr' || \Auth::user()->type === 'General Manager' || \Auth::user()->type === 'General Manager')
                    <li
   ...
   @if (\Auth::user()->type === 'company' || \Auth::user()->type === 'SuperAdmin' || \Auth::user()->type === 'hr'  ||  \Auth::user()->type === 'General Manager')
            ...
            @endif
                ...
                <!--constant-->
                @if (Gate::check('Manage Department') || Gate::check('Manage Designation') || Gate::check('Manage Document Type') || Gate::check('Manage Branch') || Gate::check('Manage Award Type') || Gate::check('Manage Termination Types') || Gate::check('Manage Payslip Type') ||
                ...
                @if (\Auth::user()->type === 'super admin' || \Auth::user()->type === 'company' || \Auth::user()->type === 'SuperAdmin'|| \Auth::user()->type === 'hr' || \Auth::user()->type === 'General Manager')
                ...
                @endif
                <!--constant-->
                @if(\Auth::user()->type === 'company' || \Auth::user()->type === 'super admin' || \Auth::user()->type === 'SuperAdmin')
