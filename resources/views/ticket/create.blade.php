...
<div class="modal-body">
    <div class="row">
        ...
        {{-- @endif --}}
         ...
         @if (\Auth::user()->type == 'employee')
         <div class="form-group">
            {{ Form::label('employee_id', __('Ticket for Manager'), ['class' => 'col-form-label']) }}
            {{ Form::select('employee_id', $managers, null, ['class' => 'form-control select2 employee_id','placeholder' => __('Select Manager')]) }}
        </div>
        @else
        <div class="form-group">
            {{ Form::label('employee_id', __('Ticket for Employee'), ['class' => 'col-form-label']) }}
