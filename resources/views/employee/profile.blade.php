...
@section('content')
    ...
    @forelse($employees as $employee)
         ...
         <div class="col-lg-3 col-sm-6">
                <div class="card hover-shadow-lg">
                    ...
                    <div class="card-body text-center client-box">
                        ...
                        <a href="#" class="text-sm text-muted mb-3">{{ ucfirst(!empty($employee->department) ? $employee->department->name : '') }}</a><br>
                        <a href="#" class="text-sm text-muted mb-3">Personal Contact #: {{ ucfirst(!empty($employee->phone) ? $employee->phone : '') }}</a><br>
                         <a href="#" class="text-sm text-muted mb-3">Official Contact #: {{ ucfirst(!empty($employee->official) ? $employee->official : '') }}</a><br>
                         
                        <a href="#" class="text-sm text-muted mb-3">{{ ucfirst(!empty($employee->designation) ? $employee->designation->name : '') }}</a>
     ...
     @endif
        ...
        <!--@if(\Auth::user()->name == $employee->name)-->
        <!--   <div class="col-xl-3">-->
