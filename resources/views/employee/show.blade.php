                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    ...
                                    @if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif']))
                                        <a href="{{ (!empty($employeedoc[$document->id]) ? $logo.'/'.$employeedoc[$document->id] : '') }}" target="_blank">
                                            <img src="{{ (!empty($employeedoc[$document->id]) ? $logo.'/'.$employeedoc[$document->id] : '') }}" height="50px" width="50px">
                                        </a>
                                    @else
