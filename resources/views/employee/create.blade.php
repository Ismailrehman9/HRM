                    ...
                    <div class="card em-card" style="height: 561px">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    {!! Form::label('Personal', __('Personal Phone'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('Personal Phone', old('Personal'), ['class' => 'form-control' ,'placeholder'=>'Enter employee Personal Phone','required' => 'required']) !!}
                                </div>
                                
                                <div class="form-group col-md-6">
                                    {!! Form::label('Official', __('Official Phone'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('Official Phone', old('Official_Phone'), ['class' => 'form-control' ,'placeholder'=>'Enter employee Official Phone','required' => 'required']) !!}
                                </div>
                                
                                <div class="form-group col-md-6">
                                    {!! Form::label('Emergency', __('Emergency Phone'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('Emergency Phone', old('Emergency_Phone'), ['class' => 'form-control' ,'placeholder'=>'Enter employee Emergency Phone','required' => 'required']) !!}
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">
                                        {{ Form::select('branch_id', $branches, old('branch_id'), ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Select Branch']) }}
                                    </div>
                                </div>
                               ...
                               <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">
                                        {{ Form::select('department_id', $departments, old('department_id'), ['class' => 'form-control ', 'id' => 'department_id', 'required' => 'required', 'placeholder' => 'Select Department']) }}
                                    </div>
                                </div>
                                ...
                                <!--    {{ Form::label('roleid', __('Roles'), ['class' => 'form-label']) }}-->

                                <!--    <div class="form-icon-user">-->
                                <!--        <div class="designation_div">-->
                                <!--            <select class="form-control  designation_id" name="role_id"-->
                                <!--                id="choices-multiple" placeholder="Select Role">-->
                                <!--            </select>-->
                                <!--        </div>-->
                                <!--    </div>-->
                                <!--</div> --}}-->
                                        ...
                                        <div class="role_div">
                                            <select class="form-control" name="role_id" id="role_id" placeholder="Select Role" >
                                                @foreach($newroles as $role)
                                                    @if($role->name == 'employee' || $role->name == 'Manager' || $role->name == 'hr' || $role->name == 'General Manager')
                        ...
                        <div class="card-body employee-detail-create-body">
                            <div class="row">
                                ...
                                {{-- <div class="form-group col-md-6">
                                    ...
                                    {!! Form::text('initial_balance ', old('initial_balance '), ['class' => 'form-control' ,'placeholder'=>'Enter Initial Balance']) !!}
                                </div> --}}
                            </div>
                        </div>
                    </div>
