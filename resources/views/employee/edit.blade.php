                    ...
                    <div class="card " style="height: 615px">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    {!! Form::label('phone', __('Personal Phone'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('phone', null, ['class' => 'form-control' ]) !!}
                                </div>
                               <div class="form-group col-md-6">
                                    {!! Form::label('official', __('Official Phone'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('official', null, ['class' => 'form-control', 'placeholder' => 'Enter employee Official Phone']) !!}
                                </div>
                                
                                <div class="form-group col-md-6">
                                    {!! Form::label('emergency', __('Emergency Phone'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('emergency', null, ['class' => 'form-control', 'placeholder' => 'Enter employee Emergency Phone']) !!}
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        {!! Form::label('dob', __('Date of Birth'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                        {!! Form::date('dob', null, ['class' => 'form-control ', 'id' => 'data_picker1','required' => 'required']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-group ">
                            ...
                            <div class="card-body">
                                <div class="row">
                                   ...
                                   <div class="form-group col-md-6">
                                            ...
                                            <div class="designation_div">
                                                <select class="form-control designation_id select2" name="designation_id" id="choices-multiple" placeholder="Select Designation">
                                                    @foreach($designations as $id => $designationName)
                                                        <option value="{{ $id }}" {{ $employee->designation_id == $id ? 'selected' : '' }}>
                                                            {{ $designationName }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <input name="user_id" value="{{ $employee->user_id}}" hidden>
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <div class="role_div">
                                                <select class="form-control" name="role_id" id="role_id" placeholder="Select Role">
                                                    <option value="{{ $role->id }}" selected>{{ $user->type }}</option>
                                                    @foreach($roles as $role)
