    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('title', null, ['class' => 'form-control', 'placeholder' => __('Enter Announcement Title')])); ?>
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::textarea('description', null, ['class' => 'form-control','placeholder' => __('Enter Announcement Title'),'rows'=>'3'])); ?>
...
<?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/announcement/edit.blade.php ENDPATH**/ ?>