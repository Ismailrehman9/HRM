                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                   ...
                                   <?php if(\Auth::user()->type == 'SuperAdmin'|| \Auth::user()->type == 'super admin'): ?>
                                    ...
                                    <?php elseif(\Auth::user()->name == $user->name): ?>
                                      <tr>
                                        <?php if($user->type == 'employee'): ?>
                                            <td><a class="btn btn-primary" href="<?php echo e(route('show.employee.profile', \Illuminate\Support\Facades\Crypt::encrypt($user->id))); ?>"><?php echo e($emp_id); ?> </a></td>
                                        <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/employee/lastLogin.blade.php ENDPATH**/ ?>