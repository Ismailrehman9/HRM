        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="choose-files ">
                    ...
                    <img id="blah" alt="your image" width="100" src="<?php if($companyPolicy->attachment): ?><?php echo e($policyPath.$companyPolicy->attachment); ?><?php else: ?><?php echo e($logo.'user-2_1654779769.jpg'); ?><?php endif; ?>" />
                    </label>
                </div>
            </div>
        </div>
...
<?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/companyPolicy/edit.blade.php ENDPATH**/ ?>