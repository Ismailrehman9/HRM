                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    ...
                                    <?php
                                        $extension = isset($employeedoc[$document->id]) ? pathinfo($employeedoc[$document->id], PATHINFO_EXTENSION) : null;
                                    ?>
                                    
                                    <?php if(in_array($extension, ['jpg', 'jpeg', 'png', 'gif'])): ?>
                                        <a href="<?php echo e((!empty($employeedoc[$document->id]) ? $logo.'/'.$employeedoc[$document->id] : '')); ?>" target="_blank">
                                            <img src="<?php echo e((!empty($employeedoc[$document->id]) ? $logo.'/'.$employeedoc[$document->id] : '')); ?>" height="50px" width="50px">
                                        </a>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/employee/show.blade.php ENDPATH**/ ?>