        ...
        <div class="m-header main-logo">
            ...
            <a href="<?php echo e(route('home')); ?>" class="b-brand">
                ...
                <img src="<?php echo e($logos . $logo); ?>" alt="<?php echo e(env('APP_NAME')); ?>"
                    class="logo logo-lg" style="height: 120px;" />
                ...
                <?php if(Gate::check('Manage Set Salary') || Gate::check('Manage Pay Slip')): ?>
                    <li
                        ...
                        <ul class="dash-submenu ">
                            ...
                            <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'SuperAdmin' || \Auth::user()->type == 'hr' || \Auth::user()->type == 'General Manager' ): ?>
                ...
                <?php if(Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage TimeSheet')): ?>
                    <li class="dash-item dash-hasmenu">
                        ...
                        <ul class="dash-submenu">
                            ...
                            <?php endif; ?>
                             <?php if(\Auth::user()->type === 'company' || \Auth::user()->type === 'SuperAdmin' || \Auth::user()->type === 'hr' ): ?>
...
<?php endif; ?>
                ...
                <?php if(\Auth::user()->type == 'SuperAdmin' || \Auth::user()->type == 'super admin' || \Auth::user()->type == 'company' || \Auth::user()->type === 'hr' || \Auth::user()->type === 'General Manager' || \Auth::user()->type === 'General Manager'): ?>
                    <li
   ...
   <?php if(\Auth::user()->type === 'company' || \Auth::user()->type === 'SuperAdmin' || \Auth::user()->type === 'hr'  ||  \Auth::user()->type === 'General Manager'): ?>
               <!-- recruitment-->
                ...
                <?php if(\Auth::user()->type == 'SuperAdmin' ||  \Auth::user()->type === 'super admin'): ?>
            ...
            <?php endif; ?>
                ...
                <!--constant-->
                <?php if(Gate::check('Manage Department') || Gate::check('Manage Designation') || Gate::check('Manage Document Type') || Gate::check('Manage Branch') || Gate::check('Manage Award Type') || Gate::check('Manage Termination Types') || Gate::check('Manage Payslip Type') ||
                ...
                <?php if(\Auth::user()->type === 'super admin' || \Auth::user()->type === 'company' || \Auth::user()->type === 'SuperAdmin'|| \Auth::user()->type === 'hr' || \Auth::user()->type === 'General Manager'): ?>
                ...
                <?php endif; ?>
                <!--constant-->
                <?php if(\Auth::user()->type === 'company' || \Auth::user()->type === 'super admin' || \Auth::user()->type === 'SuperAdmin'): ?>
...
<?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>