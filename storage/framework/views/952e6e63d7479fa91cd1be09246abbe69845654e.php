...
<?php $__env->stopSection(); ?>
 <?php else: ?>
 <?php $__env->startSection('content'); ?>
    <span>no template avaible</span>
    <?php $__env->stopSection(); ?>
    <?php endif; ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/email_templates/show.blade.php ENDPATH**/ ?>