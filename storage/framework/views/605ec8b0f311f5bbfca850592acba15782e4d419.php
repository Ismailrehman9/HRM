                    ...
                    <div class="card " style="height: 615px">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <?php echo Form::label('phone', __('Personal Phone'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('phone', null, ['class' => 'form-control' ]); ?>

                                </div>
                               <div class="form-group col-md-6">
                                    <?php echo Form::label('official', __('Official Phone'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('official', null, ['class' => 'form-control', 'placeholder' => 'Enter employee Official Phone']); ?>

                                </div>
                                
                                <div class="form-group col-md-6">
                                    <?php echo Form::label('emergency', __('Emergency Phone'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('emergency', null, ['class' => 'form-control', 'placeholder' => 'Enter employee Emergency Phone']); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::date('dob', null, ['class' => 'form-control ', 'id' => 'data_picker1','required' => 'required']); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::textarea('address', null, ['class' => 'form-control', 'rows' => 2,'required' => 'required']); ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                   ...
                                   <div class="form-group col-md-6">
                                        ...
                                        <div class="form-icon-user">
                                            <div class="designation_div">
                                                <select class="form-control designation_id select2" name="designation_id" id="choices-multiple" placeholder="Select Designation">
                                                    <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $designationName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($id); ?>" <?php echo e($employee->designation_id == $id ? 'selected' : ''); ?>>
                                    ...
                                    <input name="user_id" value="<?php echo e($employee->user_id); ?>" hidden>
                                                ...
                                                <select class="form-control" name="role_id" id="role_id" placeholder="Select Role">
                                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                       <?php if($role->name == 'employee' || $role->name == 'Manager' || $role->name == 'hr' || $role->name == 'General Manager'): ?>
                                                        <option value="<?php echo e($role->id); ?>" <?php echo e($user->type == $role->name ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/employee/edit.blade.php ENDPATH**/ ?>