                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <!--<td><?php echo e($current_employee->name ?? \Auth::user()->name); ?></td>-->
                                    <td class="Action">
                                        <?php if(Gate::check('Edit Announcement') || Gate::check('Delete Announcement')): ?>
                                            <span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/announcement/index.blade.php ENDPATH**/ ?>