...
<div class="modal-body">
    <div class="row">
        <div class="form-group">
         ...
         <div class="form-group">
            <?php echo e(Form::label('employee_id', __('Ticket for Manager'), ['class' => 'col-form-label'])); ?>

            <?php echo e(Form::select('employee_id', $managers, null, ['class' => 'form-control select2 employee_id','placeholder' => __('Select Manager')])); ?>
...
<?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/ticket/create.blade.php ENDPATH**/ ?>