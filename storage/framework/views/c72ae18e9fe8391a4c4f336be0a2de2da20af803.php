...
<?php $__env->startSection('content'); ?>
    <div class="">
        <div class="">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card em-card" style="height: 561px">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <?php echo Form::label('Personal', __('Personal Phone'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('Personal Phone', old('Personal'), ['class' => 'form-control' ,'placeholder'=>'Enter employee Personal Phone','required' => 'required']); ?>

                                </div>
                                
                                <div class="form-group col-md-6">
                                    <?php echo Form::label('Official', __('Official Phone'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('Official Phone', old('Official_Phone'), ['class' => 'form-control' ,'placeholder'=>'Enter employee Official Phone','required' => 'required']); ?>

                                </div>
                                
                                <div class="form-group col-md-6">
                                    <?php echo Form::label('Emergency', __('Emergency Phone'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('Emergency Phone', old('Emergency_Phone'), ['class' => 'form-control' ,'placeholder'=>'Enter employee Emergency Phone','required' => 'required']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">
                                        <?php echo e(Form::select('branch_id', $branches, old('branch_id'), ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Select Branch'])); ?>
                               ...
                               <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">
                                        <?php echo e(Form::select('department_id', $departments, old('department_id'), ['class' => 'form-control ', 'id' => 'department_id', 'required' => 'required', 'placeholder' => 'Select Department'])); ?>
                                ...
                                <div class="form-group">
                                    <?php echo e(Form::label('roleid', __('Roles'), ['class' => 'form-label'])); ?>

                                    <div class="form-icon-user">
                                        <div class="role_div">
                                            <select class="form-control" name="role_id" id="role_id" placeholder="Select Role" >
                                                <?php $__currentLoopData = $newroles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($role->name == 'employee' || $role->name == 'Manager' || $role->name == 'hr' || $role->name == 'General Manager'): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/employee/create.blade.php ENDPATH**/ ?>