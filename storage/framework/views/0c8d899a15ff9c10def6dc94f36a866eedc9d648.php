                    ...
                    <table class="table" id="pc-dt-simple">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $accountlists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accountlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($accountlist->account_holder_name); ?></td>
                                    <td><?php echo e(\Auth::user()->priceFormat($accountlist->initial_balance)); ?></td>
                                    <td><?php echo e($accountlist->account_number); ?></td>
                                    <td><?php echo e($accountlist->bank_name); ?></td>
                                    <td><?php echo e($accountlist->bank_identifier_code); ?></td>
                                    <td><?php echo e($accountlist->branch_location); ?></td>
                                    <td class="Action">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/devopcom/hrm.devop360.com/resources/views/accountlist/index.blade.php ENDPATH**/ ?>